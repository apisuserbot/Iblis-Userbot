# BASED FROM ULTROID PORTED FOR LORD USERBOT FOR IBLIS USERBOT BY Imbakaaaaa/_mocpi
# THANKS ULTROID
# DONT REMOVE THIS
# RIMURU GANTENG
# @IBLIS_USERBOT
...
async def _(event):
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            return
        await event.edit(f"**IBLIS TEMPMAIL** ~ `{response.message.message}`\n\n[KLIK DISINI UNTUK VERIFIKASI]({lorduserbot})")


# Rimuru Ganteng
# Ported For Lord Userbot From Ultroid For Iblis Userbot
