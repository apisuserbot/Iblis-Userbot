...
@register(outgoing=True, pattern=r"^\.(?:tuan|lordon)\s?(.)?")
async def amireallyalive(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    await alive.edit("`I'M RIMURU!`")
    await alive.edit("࿋")
    output = (
        f" **┗┓IBLIS USERBOT┏┛** \n"
        f"\n__**{IBLIS_TEKS_KUSTOM}**__\n"
        f"**━━━━❈━━━━━━❈━━━━━━❈━━━━**\n"
        f"**࿋ ᴛᴜᴀɴ** \n"
        f" ➥ `{DEFAULTUSER}` \n"
        f"**࿋ ᴜsᴇʀɴᴀᴍᴇ** \n"
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"❃ **ᴠᴇʀꜱɪ ʙᴏᴛ**\n   ➥ `{BOT_VER}` \n"
        f"❃ **ᴍᴏᴅᴜʟ**    \n   ➥ `{len(modules)}` \n\n"
        f"❃ **ʀᴇᴘᴏ ᴜꜱᴇʀʙᴏᴛ:** [Iblis-Userbot](https://github.com/rimuru07/Iblis-Userbot)\n❃ **Grup Userbot: **[Tekan](t.me/Iblis-Userbot)\n❃ **Pemilik:** [rimuru](t.me/imbakaaaaa)\n"
        f"**▬❈▬❈▬❈▬❈▬❈▬❙۩★۩❙▬❈▬❈▬❈▬❈▬❈▬**")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        f"**࿋ IBLIS USERBOT ࿋** \n\n"
        f"┏━━━━━━━━━━━━━━━━━━━ \n"
        f"┣|• `ꜱᴇɴᴘᴀɪ     :`{DEFAULTUSER} \n"
        f"┣|• `ᴜꜱᴇʀɴᴀᴍᴇ :`@{user.username} \n"
        f"┣|• `ᴛᴇʟᴇᴛʜᴏɴ :`Ver {version.__version__} \n"
        f"┣|• `ᴘʏᴛʜᴏɴ   :`Ver {python_version()} \n"
        f"┣|• `ʙʀᴀɴᴄʜ   :`{UPSTREAM_REPO_BRANCH} \n"
        f"┣|• `ʙᴏᴛ ᴠᴇʀ  :`{BOT_VER} \n"
        f"┣|• `ᴍᴏᴅᴜʟᴇꜱ  :`{len(modules)} Modules \n"
        f"┗━━━━━━━━━━━━━━━━━━━ \n\n"
        f"[Repo](https://github.com/rimuru07/Iblis-Userbot) | [Grup Support](t.me/Iblis_Userbot) | [Owner](t.me/imbakaaaaa)")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
