...
# ====================== CONSTANT ===============================
INVALID_MEDIA = "```Maaf Senpai Media Tidak Valid.```"
PP_CHANGED = "```Senpai, Foto Profil Anda Telah Berhasil Diubah.```"
PP_TOO_SMOL = "```Gambar Terlalu Kecil Senpai, Mohon Gunakan Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah.```"

BIO_SUCCESS = "```Senpai, Bio Anda Telah Berhasil Diubah.```"

NAME_OK = "```Senpai, Nama Anda Telah Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Sudah Diubah.```"
USERNAME_TAKEN = "```Mohon Maaf Senpai, Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
