...
async def _(event):
    ...
    if c.admin_rights or c.creator:
        ...
        await event.edit("Senpai Anda memerlukan izin Admin untuk melakukan perintah ini")
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.edit("`Mohon Balas Ke Media Senpai`")
...
async def weebify(event):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await event.edit("`Senpai, Teks Apa Yang Harus Saya Weebify Kan?`")
        return
...
async def thicc(bolded):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await bolded.edit("`Senpai, Teks Apa Yang Harus Saya Bold Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def doublex(doublestrucktx):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await doublestrucktx.edit("`Senpai, Teks Apa Yang Harus Saya Double Struck Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def cursive2(cursivebolded):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await cursivebolded.edit("`Senpai, Teks Apa Yang Harus Saya Cursive Bold Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def medival22(medivallite):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await medivallite.edit("`Senpai, Teks Apa Yang Harus Saya Medival Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
...
async def xcursive(cursivelite):
    ...
    if not args:
        ...
        args = get.text
    if not args:
        await cursivelite.edit("`Senpai, Teks Apa Yang Harus Saya Cursive Kan?`")
        return
    string = ''.join(args).lower()
    for normiecharacter in string:
        if normiecharacter in normiefont:
