...
# Rimuru Gans
# Rimuru Gansssss Anjjjayy Yahahaha
...
async def insta(event):
    ...
    if not event.reply_to_msg_id:
        await event.edit("`Senpai, Mohon Balas Ke Link Instagram`")
        return
    reply_message = await event.get_reply_message()
    if not reply_message.text:
        await event.edit("`Mohon Maaf Senpai, Saya Membutuhkan Link Media Instagram Untuk Download`")
        return
    chat = "@SaveAsBot"
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await event.edit("`Senpai, Mohon Buka Blokir` @SaveAsbot `Lalu Coba Lagi`")
            return
        if response.text.startswith("Forward"):
            ...
            await event.client.send_file(
                ...
                caption=f"**Download By @Iblis_userbot**",
            )
...
# By Iblis - Userbot
# Rimuru Gansssssss Mksh Sma Sma
# Rimuru Gans
