...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Iblis-Userbot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`Ibis-Userbot Telah Dimatikan`")
    await bot.disconnect()


@register(outgoing=True, pattern="^.restart$")
async def killdabot(event):
    await event.edit("`Restarting Iblis-Userbot...`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#RESTARTBOT \n"
                                        "`Iblis-Userbot Telah Di Restart`")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Iblis-Userbot Repo](https://github.com/rimuru07/Iblis-Userbot/blob/Iblis-Userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "╭╍─❈─╍❈╍─❈─╍❈╍─❈╮\n"
        "❈               repo\n"
        "❈  [❈Iblis Userbot❈](https://github.com/rimuru07/Iblis-Userbot)\n"
        "❈ **[❈ꜱᴇɴꜱᴇɪ❈] :** [rimuru](t.me/imbakaaaaa)\n"
        "❈─❈─❈─❈─❈─❈─❈─❈─"
    )
...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("`Harap Balas Di Gambar Senpai`")
        return
